...
const fetchCustomerPayments = async () => {
  try {
    const response = await fetch(`https://api.reparv.in/territory-partner/customers/payment/get/${data?.enquirerId}`, {
      method: 'GET',
      credentials: 'include',
      headers: {
...
const getCustomer=async()=>{
  ...
  try {
    fetch(`https://api.reparv.in/territory-partner/customers/payment/get/${data.enquirerid}`, {
      method: 'GET',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json',
