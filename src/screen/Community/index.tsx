...
const [followers, setFollowers] = useState<any[]>([]);
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch('https://api.reparv.in/territoryapp/user/'); // Update with your actual domain
          ...
          <ScrollView>
            <View
              ...
              {posts !== null ? (
                ...
                <Text style={{fontSize: 15,color:'black'}}>Not Found Any Post !</Text>
              )}
